...
**Change:** Added boolean variable "autogenerated_lb_name" (default 'false')-preserves module historic behaviour. set to 'true' to avoid load_balancer name collision

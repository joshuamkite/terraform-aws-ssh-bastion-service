...
**Change:** Added variable "service_name" (default "`bastion-service`" to preserve module historic behaviour). Set this to a different value to avoid resource name collision when deploying more than one service using this module per vpc.
